...
public class Core {
  ...
  public static int LLVMAddTypeName(SWIGTYPE_p_LLVMOpaqueModule M, String Name, SWIGTYPE_p_LLVMOpaqueType Ty) {
    return CoreJNI.LLVMAddTypeName(SWIGTYPE_p_LLVMOpaqueModule.getCPtr(M), Name, SWIGTYPE_p_LLVMOpaqueType.getCPtr(Ty));
  }

  public static void LLVMDeleteTypeName(SWIGTYPE_p_LLVMOpaqueModule M, String Name) {
    CoreJNI.LLVMDeleteTypeName(SWIGTYPE_p_LLVMOpaqueModule.getCPtr(M), Name);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueType LLVMUnionTypeInContext(SWIGTYPE_p_LLVMOpaqueContext C, SWIGTYPE_p_p_LLVMOpaqueType ElementTypes, long ElementCount) {
    long cPtr = CoreJNI.LLVMUnionTypeInContext(SWIGTYPE_p_LLVMOpaqueContext.getCPtr(C), SWIGTYPE_p_p_LLVMOpaqueType.getCPtr(ElementTypes), ElementCount);
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }

  public static SWIGTYPE_p_LLVMOpaqueType LLVMUnionType(SWIGTYPE_p_p_LLVMOpaqueType ElementTypes, long ElementCount) {
    long cPtr = CoreJNI.LLVMUnionType(SWIGTYPE_p_p_LLVMOpaqueType.getCPtr(ElementTypes), ElementCount);
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }

  public static long LLVMCountUnionElementTypes(SWIGTYPE_p_LLVMOpaqueType UnionTy) {
    return CoreJNI.LLVMCountUnionElementTypes(SWIGTYPE_p_LLVMOpaqueType.getCPtr(UnionTy));
  }

  public static void LLVMGetUnionElementTypes(SWIGTYPE_p_LLVMOpaqueType UnionTy, SWIGTYPE_p_p_LLVMOpaqueType Dest) {
    CoreJNI.LLVMGetUnionElementTypes(SWIGTYPE_p_LLVMOpaqueType.getCPtr(UnionTy), SWIGTYPE_p_p_LLVMOpaqueType.getCPtr(Dest));
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueType LLVMOpaqueTypeInContext(SWIGTYPE_p_LLVMOpaqueContext C) {
    long cPtr = CoreJNI.LLVMOpaqueTypeInContext(SWIGTYPE_p_LLVMOpaqueContext.getCPtr(C));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueType LLVMOpaqueType() {
    long cPtr = CoreJNI.LLVMOpaqueType();
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }

  public static SWIGTYPE_p_LLVMOpaqueTypeHandle LLVMCreateTypeHandle(SWIGTYPE_p_LLVMOpaqueType PotentiallyAbstractTy) {
    long cPtr = CoreJNI.LLVMCreateTypeHandle(SWIGTYPE_p_LLVMOpaqueType.getCPtr(PotentiallyAbstractTy));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueTypeHandle(cPtr, false);
  }

  public static void LLVMRefineType(SWIGTYPE_p_LLVMOpaqueType AbstractTy, SWIGTYPE_p_LLVMOpaqueType ConcreteTy) {
    CoreJNI.LLVMRefineType(SWIGTYPE_p_LLVMOpaqueType.getCPtr(AbstractTy), SWIGTYPE_p_LLVMOpaqueType.getCPtr(ConcreteTy));
  }

  public static SWIGTYPE_p_LLVMOpaqueType LLVMResolveTypeHandle(SWIGTYPE_p_LLVMOpaqueTypeHandle TypeHandle) {
    long cPtr = CoreJNI.LLVMResolveTypeHandle(SWIGTYPE_p_LLVMOpaqueTypeHandle.getCPtr(TypeHandle));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }

  public static void LLVMDisposeTypeHandle(SWIGTYPE_p_LLVMOpaqueTypeHandle TypeHandle) {
    CoreJNI.LLVMDisposeTypeHandle(SWIGTYPE_p_LLVMOpaqueTypeHandle.getCPtr(TypeHandle));
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueValue LLVMIsAEHSelectorInst(SWIGTYPE_p_LLVMOpaqueValue Val) {
    long cPtr = CoreJNI.LLVMIsAEHSelectorInst(SWIGTYPE_p_LLVMOpaqueValue.getCPtr(Val));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueValue(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueValue LLVMIsAUnwindInst(SWIGTYPE_p_LLVMOpaqueValue Val) {
    long cPtr = CoreJNI.LLVMIsAUnwindInst(SWIGTYPE_p_LLVMOpaqueValue.getCPtr(Val));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueValue(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueValue LLVMConstUnion(SWIGTYPE_p_LLVMOpaqueType Ty, SWIGTYPE_p_LLVMOpaqueValue Val) {
    long cPtr = CoreJNI.LLVMConstUnion(SWIGTYPE_p_LLVMOpaqueType.getCPtr(Ty), SWIGTYPE_p_LLVMOpaqueValue.getCPtr(Val));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueValue(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueValue LLVMBuildUnwind(SWIGTYPE_p_LLVMOpaqueBuilder arg0) {
    long cPtr = CoreJNI.LLVMBuildUnwind(SWIGTYPE_p_LLVMOpaqueBuilder.getCPtr(arg0));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueValue(cPtr, false);
  }
