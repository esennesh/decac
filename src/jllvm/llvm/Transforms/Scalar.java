...
public class Scalar {
  ...
  public static void LLVMAddLoopIndexSplitPass(SWIGTYPE_p_LLVMOpaquePassManager PM) {
    ScalarJNI.LLVMAddLoopIndexSplitPass(SWIGTYPE_p_LLVMOpaquePassManager.getCPtr(PM));
  }
