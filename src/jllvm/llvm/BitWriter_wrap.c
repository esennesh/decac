...
SWIGEXPORT jint JNICALL Java_jllvm_llvm_BitWriterJNI_LLVMWriteBitcodeToFile(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2) {
  jint jresult = 0 ;
  LLVMModuleRef arg1 ;
  char *arg2 = (char *) 0 ;
  LLVMModuleRef *argp1 ;
...
SWIGEXPORT jint JNICALL Java_jllvm_llvm_BitWriterJNI_LLVMWriteBitcodeToFileHandle(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2) {
  jint jresult = 0 ;
  LLVMModuleRef arg1 ;
  int arg2 ;
  LLVMModuleRef *argp1 ;
