...
class UninferredBoolean(yes: Boolean) extends UninferredExpression(BooleanGamma) {
  val value = yes
...
class BooleanConstant(yes: Boolean) extends Expression(BooleanGamma) {
...
class SpecializedBoolean(yes: Boolean) extends SpecializedExpression(BooleanGamma) {
  val value: Boolean = yes
